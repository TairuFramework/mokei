...
What remains (as of 2026-08-27): B4 (`subscriptions/listen`) and D1–D3. B4 is tracked in
`next/2026-08-27-mcp-2026-07-28-subscriptions.md`; D1–D3 and the tidy-ups in
`backlog/2026-06-20-mcp-2026-07-28-deprecations-cleanup.md` (the former
`2026-06-20-mcp-draft-remaining.md`, split 2026-08-27). B7 (MRTR), the roots half of B6, and G7
part 5's retry loop all shipped.
