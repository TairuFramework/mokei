...
**Relates to:** `completed/2026-08-28-mcp-2026-07-28-migration-milestone.complete.md` (Architecture decision / ADR) · `backlog/2026-06-20-mcp-draft-remaining.md` (B7 plugs into this seam)
