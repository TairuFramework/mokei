...
> **AnyMessage** = [`SingleMessage`](#singlemessage) \| [`Request`](#request)[] \| [`Response`](#response)[]
...
> **ClientMessage** = [`SingleClientMessage`](#singleclientmessage) \| [`ClientRequest`](#clientrequest)[] \| `ClientResponse`[]
...
> **ServerMessage** = [`SingleServerMessage`](#singleservermessage) \| [`ServerRequest`](#serverrequest)[] \| `ServerResponse`[]
...
> **SingleClientMessage** = `FromSchema`\<*typeof* [`singleClientMessage`](#singleclientmessage-1)\>

***

### SingleMessage

> **SingleMessage** = [`Notification`](#notification) \| [`Request`](#request) \| [`Response`](#response)

***

### SingleServerMessage

> **SingleServerMessage** = `FromSchema`\<*typeof* [`singleServerMessage`](#singleservermessage-1)\>
...
> `const` **LATEST\_PROTOCOL\_VERSION**: `"2025-03-26"` = `'2025-03-26'`
...
> `const` **singleClientMessage**: `object`
...
> `const` **singleServerMessage**: `object`
